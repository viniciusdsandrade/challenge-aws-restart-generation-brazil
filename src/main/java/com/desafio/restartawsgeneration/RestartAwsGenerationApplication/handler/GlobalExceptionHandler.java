package com.desafio.restartawsgeneration.RestartAwsGenerationApplication.handler;

import com.desafio.restartawsgeneration.RestartAwsGenerationApplication.exception.DuplicateEntryException;
...
public class GlobalExceptionHandler {
    ...
    /**
     * Manipula a exceção {@link MatriculaNotFoundException}, que é lançada quando uma matrícula
     * não é encontrada.
     * <p>
     * Esta exceção é comum em operações de busca ou atualização, onde a matrícula fornecida
     * não corresponde a nenhuma entidade existente. O método encapsula os detalhes do erro em
     ...
     * </p>
     *
     * @param exception  A exceção de matrícula não encontrada, que contém a mensagem de erro a ser retornada ao cliente.
    ...
    @Schema(description = "Manipula a exceção MatriculaNotFoundException, lançada quando uma matrícula não é encontrada.")
    public ResponseEntity<List<ErrorDetails>> handleMatriculaNotFoundException(MatriculaNotFoundException exception,
